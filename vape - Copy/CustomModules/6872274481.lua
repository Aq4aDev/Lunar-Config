...
runFunction(function()
	...
	scaffoldtext.Font = Enum.Font.Arial
	scaffoldtext.TextSize = 17
				...
				task.spawn(function()
					repeat
						...
						if entityLibrary.isAlive then
							...
							scaffoldtext.Text = "Blocks: ".. (woolamount and tostring(woolamount) or "0")
							scaffoldtext.TextColor3 = Color3.fromRGB(255, 255, 255)
...
runFunction(function()
local funnyhighjump = {Enabled = false}
funnyhighjump = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
Name = "FunnyHighJump",
Function = function(callback)
if callback then
  if entityLibrary.isAlive then
 Workspace.Gravity = 192.6
 entityLibrary.character.HumanoidRootPart.Velocity = entityLibrary.character.HumanoidRootPart.Velocity + Vector3.new(0, 500, 0)
	 task.wait(0.2)
	 Workspace.Gravity = 10
	 task.wait(0.6)
	 Workspace.Gravity = 192.6
	 funnyhighjump["ToggleButton"](false)
  end
end
end
})
